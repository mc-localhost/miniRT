...
/*   Updated: 2025/03/23 15:16:43 by vvasiuko         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_hit	hit_plane(t_ray r, t_obj *pl)
{
	...
	if (fabs(dot) > 1e-6) //plane norm and ray are not parallel, 1e-5 to account for floating point precision, otherwise should be 0
