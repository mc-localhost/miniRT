...
#    Updated: 2025/04/07 06:57:15 by ykhattab         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FILES			= cleanup error main parse utils vector_ops vector_ops_2 vector_ops_inplace colour put_pixels sphere cylinder translate_camera translate_sphere translate_plane key_events rotate_camera rotate_object plane \
